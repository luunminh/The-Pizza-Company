        ...
        <div class="grid wide">
            ...
            <div class="content">
                <div class="form-container">
                    ...
                    <form action="HandleUpdateMonAn" class="form-login" method="post">
                        <div class="form-input-group">
                        <%monan monAn = (monan)request.getAttribute("monAn");
                    		String pizzaSelected = "";
                    		String pastaSelected = "";
                    		String saladSelected = "";
                    		if(monAn.getTheLoai() == "pizza"){
                    			pizzaSelected = "selected";
                    		} if(monAn.getTheLoai() == "pasta"){
                    			pastaSelected = "selected";
                    		} if(monAn.getTheLoai() =="salad") {
                    			saladSelected="selected";
                    		}
                    		%>
                            <div class="form-label">Mã món ăn</div>
                            <input type="text" value="<%=monAn.getMaMonAn() %>" placeholder="Nhập mã món ăn tại đây" name="maMonAn" class="form-input" readonly>
                        </div>
                        <div class="form-input-group">
                            <div class="form-label">Tên món ăn</div>
                            <input type="text" value="<%=monAn.getTenMonAn()%>" placeholder="Nhập tên món ăn tại đây" name="tenMonAn" class="form-input">
                        </div>
                        <div class="form-input-group">
                            <div class="form-label">Thể loại món ăn</div>
                            <Select class="userCbb" name="theloaiMonAn">
                                <option value="pizza" <%=pizzaSelected %>>Pizza</option>
                                <option value="pasta" <%=pastaSelected %>>Mỳ ý</option>
                                <option value="salad" <%=saladSelected %>>Salad</option>
                            </Select>
                        </div>
                        <div class="form-input-group">
                            <div class="form-label">Giá món ăn</div>
                            <input type="text" value="<%=monAn.getGia()%>" placeholder="Hình ảnh món ăn" name="giaMonAn" class="form-input">
                        </div>
                        <div class="form-input-group">
                            <div class="form-label">Mô tả</div>
                            <input type="text" value="<%=monAn.getMoTa()%>" placeholder="Mô tả của món ăn" name="motaMonAn" class="form-input"
                                rows="3">
                        </div>
                        <div class="form-input-group">
                            <div class="form-label">Link hình ảnh món ăn</div>
                            <input type="text" value="<%=monAn.getAnh() %>" placeholder="Hình ảnh món ăn" name="hinhanhMonAn" class="form-input">
                        </div>
