                        ...
                        <div class="product c-3 col">
                            <div class="product-img-container">
                                <a href="" class="product-img-link">
                                    <img src="./assetss/img/salad/signature.png" alt="" class="product-img">
                                </a>
                            </div>

                            <div class="product-name">
                                <a href="" class="product-link-name">Salad Đặc Sắc</a>
                            </div>
                            <div class="product-desc">
                                <p class="product-desc-detail">Bông cải xanh, búp cải tím, táo, xà lách, trứng… và sốt
                                    Salad đặc biệt</p>
                            </div>
                            <div class="product-bottom">
                                <div class="product-bottom-price">
                                    <p class="price-title">Giá chỉ từ</p>
                                    <p class="product-price">79.000đ</p>
                                </div>
