                ...
                <div class="form-container">
                    ...
                    <form action="" class="form-login">
                        <div class="form-input-group">
                            ...
                            <input type="text" placeholder="Nhập họ và tên tại đây" name="tenTK" class="form-input">
                        </div>
                        <div class="form-input-group">
                            <div class="form-label">Số điện thoại</div>
                            <input type="tel" placeholder="Nhập số điện thoại tại đây" name="tenTK" class="form-input">
                        </div>
                        <div class="form-input-group">
                            <div class="form-label">Địa chỉ</div>
                            <input type="text" placeholder="Nhập địa chỉ tại đây" name="tenTK" class="form-input"
                                rows="3">
                        </div>
                        <div class="form-input-group">
                            <div class="form-label">Phân quyền</div>
                            <Select class="userCbb">
                                <option value="admin" name="admin">Quản lý</option>
                                <option value="customer" name="customer">Khách hàng</option>
                            </Select>
                        </div>
                        <div class="form-input-group">
