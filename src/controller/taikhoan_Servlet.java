...
public class taikhoan_Servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(checkBO.isValidUser(tenTK,password)) {
			...
			monan_bo MonAnBO = new monan_bo();
			ArrayList<monan> listMonAn = MonAnBO.getAllMonAnPizzaActive();
			request.setAttribute("listMonAn",listMonAn);
			ArrayList<monan> listPastaMonAn = MonAnBO.getAllMonAnPastaActive();
			request.setAttribute("listPastaMonAn",listPastaMonAn);
			ArrayList<monan> listSaladMonAn = MonAnBO.getAllMonAnSaladActive();
